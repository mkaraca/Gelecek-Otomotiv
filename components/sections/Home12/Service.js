...
function Service() {    
    return (
        ...
        <section id="service-menu" className="service-twelve-area pt-130 pb-130">
                ...
                <div className="row g-0">
                    ...
                    <div className="col-lg-4">
                        <div className="service-twelve__item">
                            ...
                            <Link href="/page-about" className="btn-one px-5 rounded-0 mt-40" data-splitting data-text="Read More">Read More</Link>
                        </div>
                    </div>
                    <div className="col-lg-4">
