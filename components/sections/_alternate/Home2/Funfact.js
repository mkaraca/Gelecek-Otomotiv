                    ...
                    <div className="col-md-6 col-xxl-3">
                        <div className="funfact__item">
                            <ul className="wow fadeInDown" data-wow-delay="00ms" data-wow-duration="1500ms">
                                <li><i className="fa-solid fa-plus" /> Consultation Services</li>
                                <li><i className="fa-solid fa-plus" /> Spatial Design</li>
                                <li><i className="fa-solid fa-plus" /> Idea Generation</li>
                            </ul>
                    ...
                    <div className="col-md-6 col-xxl-3">
                        <div className="funfact__item">
                            <ul className="wow fadeInDown" data-wow-delay="100ms" data-wow-duration="1500ms">
                                <li><i className="fa-solid fa-plus" /> Consultation</li>
                                <li><i className="fa-solid fa-plus" /> Space Design</li>
                                <li><i className="fa-solid fa-plus" /> Idea Development</li>
                            </ul>
                    ...
                    <div className="col-md-6 col-xxl-3">
                        <div className="funfact__item">
                            <ul className="wow fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
                                <li><i className="fa-solid fa-plus" /> Design Refinement</li>
                                <li><i className="fa-solid fa-plus" /> 3D Rendering</li>
                                <li><i className="fa-solid fa-plus" /> Project Coordination</li>
                            </ul>
                    ...
                    <div className="col-md-6 col-xxl-3">
                        <div className="funfact__item">
                            <ul className="wow fadeInDown" data-wow-delay="300ms" data-wow-duration="1500ms">
                                <li><i className="fa-solid fa-plus" /> Furniture Selection and Acquisition</li>
                                <li><i className="fa-solid fa-plus" /> Lighting Planning</li>
                                <li><i className="fa-solid fa-plus" /> Custom Design Features</li>
                            </ul>
